...
from linebot.v3.messaging import (ApiClient, ButtonsTemplate, CarouselColumn,
                                  CarouselTemplate, Configuration,
                                  ConfirmTemplate, DatetimePickerAction,
                                  FlexContainer, FlexMessage,
                                  ImageCarouselColumn, ImageCarouselTemplate,
                                  ImagemapArea, ImagemapBaseSize,
                                  ImagemapExternalLink, ImagemapMessage,
                                  ImagemapVideo, MessageAction,
                                  MessageImagemapAction, MessagingApi,
                                  PostbackAction, ReplyMessageRequest,
                                  TemplateMessage, URIAction,
                                  URIImagemapAction)
            ...
            "contents": [
                {
                    ...
                    "action": {
                        "type": "uri",
                        "label": "IG",
                        "uri": "https://www.instagram.com/guobei_zih_yan/",
                    },
                },
                {
                    "type": "button",
                    ...
                    "action": {
                        "type": "uri",
                        "label": "YT",
                        "uri": "https://www.youtube.com/@NTUEIRC",
                    },
                },
            ],
            "flex": 0,
    ...
    "choose vocation": lambda: TemplateMessage(
        ...
        template=ButtonsTemplate(
            ...
            actions=[
                ...
                URIAction(
                    label="View Detail",
                    uri="https://zh.wikipedia.org/wiki/%E6%AD%A3%E8%A6%8F%E7%9A%84%E6%88%8F%E8%BF%B9",
                ),
                DatetimePickerAction(
                    label="Select Date",
                    data="action=selct_date",
                    mode="date",
                    initial="2024-06-01",
                    max="2024-12-31",
                    min="2024-01-01",
            ...
            columns=[
                ...
                CarouselColumn(
                    ...
                    actions=[
                        ...
                        MessageAction(
                            label="Princess Bubblegum", text="Princess Bubblegum"
                        ),
                    ],
                ),
            ]
...
def handle_message(event):
    with ApiClient(configuration) as api_client:
        ...
        if text in MESSAGE_HANDLERS:
            ...
            template_message = (
                handler_func() if callable(handler_func) else handler_func
            )
